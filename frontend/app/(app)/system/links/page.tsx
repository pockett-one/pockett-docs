        ...
        <div className="flex flex-col space-y-8">
            ...
            <div className="w-full max-w-2xl bg-gray-50/50 rounded-2xl border border-gray-200 p-6 sm:p-8">
                <div className="space-y-3">
                    <LinkGenerator label="LinkedIn" utmSource="linkedin" icon={Linkedin} colorClass="text-[#0077b5]" baseUrl={baseUrl} />
                    <LinkGenerator label="WhatsApp" utmSource="whatsapp" icon={WhatsAppIcon} colorClass="text-[#25D366]" baseUrl={baseUrl} />
                    <LinkGenerator label="Email" utmSource="email" icon={Mail} colorClass="text-gray-700" baseUrl={baseUrl} />
                    <LinkGenerator label="Twitter / X" utmSource="twitter" icon={Twitter} colorClass="text-black" baseUrl={baseUrl} />
                    <LinkGenerator label="Reddit" utmSource="reddit" icon={RedditIcon} colorClass="text-[#FF4500]" baseUrl={baseUrl} />
                    <LinkGenerator label="Facebook Group" utmSource="facebook" icon={Facebook} colorClass="text-[#1877F2]" baseUrl={baseUrl} />
                    <LinkGenerator label="Discord" utmSource="discord" icon={DiscordIcon} colorClass="text-[#5865F2]" baseUrl={baseUrl} />
                </div>
            </div>
        </div>
    )
