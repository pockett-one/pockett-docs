    ...
    return (
        <div className="relative min-h-[70vh] px-4 py-16">
            <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden>
                <div className="absolute -left-16 top-8 h-64 w-64 rounded-full bg-violet-200/30 blur-3xl" />
                <div className="absolute -right-14 top-28 h-56 w-56 rounded-full bg-indigo-200/25 blur-3xl" />
            </div>
            ...
            <div className="mx-auto flex max-w-xl items-center justify-center">
                <div className="relative w-full overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-7 text-center shadow-[0_2px_8px_rgba(15,23,42,0.04),0_16px_40px_-12px_rgba(15,23,42,0.12)] ring-1 ring-slate-900/[0.04]">
                    <div className="pointer-events-none absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-violet-50/80 via-violet-50/30 to-transparent" />
                    <div className="absolute inset-x-0 top-0 h-1 rounded-t-2xl bg-slate-200/70">
                    <div
                        className="h-1 rounded-t-2xl bg-violet-600 transition-[width] duration-1000 ease-linear"
                        style={{ width: `${progressPercent}%` }}
                    />
                </div>

                    <div className="relative z-10 mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full border border-violet-200/70 bg-gradient-to-br from-violet-100 to-indigo-50 text-slate-900">
