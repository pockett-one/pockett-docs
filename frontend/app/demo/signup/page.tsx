            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className={`h-12 bg-white/50 border-2 transition-all duration-200 focus:bg-white ${errors.firstName ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-indigo-500"
                      }`}
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={`h-12 bg-white/50 border-2 transition-all duration-200 focus:bg-white ${errors.lastName ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-indigo-500"
                      }`}
              ...
              <div>
                ...
                <Input
                  ...
                  className={`h-12 bg-white/50 border-2 transition-all duration-200 focus:bg-white ${errors.email ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-indigo-500"
                    }`}
