...
export const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer: `No! ${BRAND_NAME} is designed for independent consultants and boutique firms who need professional tools without complex IT setup. You can connect your own accounts and start protecting your Intellectual Property immediately.`,
    displayAnswer: `No! ${brandNameInlineHtml()} is designed for <strong>independent consultants</strong> and boutique firms who need professional tools <strong>without complex IT setup</strong>. You can connect your own accounts and start protecting your <strong>Intellectual Property</strong> immediately.`,
    category: "General"
  }
]