...
const KINETIC: LandingTheme = {
  ...
  skin: 'kinetic',
  pageRoot:
    'min-h-screen bg-transparent text-[#1b1b1d] font-sans selection:bg-[#72ff70] selection:text-[#002203] overflow-hidden',
  heroSection: 'relative pt-4 pb-8 lg:pt-6 lg:pb-12',
  heroGiant: 'hidden',
  heroBadge: `inline-flex items-center gap-2 px-3 py-1 bg-[#72ff70] text-[#002203] text-[10px] font-bold tracking-tight mb-6 [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  heroBadgeIcon: 'w-3 h-3 text-[#006e16] stroke-2',
  ...
  heroGradient: `text-[#006e16]`,
  heroTaglineAccent: `text-[#006e16] font-bold [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  ...
  heroPrimaryCta: `w-full sm:w-auto h-14 px-8 rounded-md bg-[#72ff70] hover:brightness-110 text-[#002203] text-base font-bold tracking-widest transition-all border-0 shadow-lg shadow-[#72ff70]/20 [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  ...
  heroSecondaryIconHover: `text-[#72ff70] opacity-90`,
  ...
  slideTintSelected: `bg-[#72ff70]/25`,
  slideCheckBg: `bg-[#006e16] border-[#006e16]`,
  slideFileAccent: `text-[#5a78ff]`,
  slideFileNameSelected: `text-[#1b1b1d]`,
  slideImportBtn: `h-8 text-xs bg-[#006e16] hover:bg-[#00530e]`,
  treeHighlight: `bg-[#72ff70]/35 text-[#002203]`,
  treeProjectActive: `text-[#1b1b1d] font-medium text-sm bg-white rounded-md border border-black/[0.1] ${SF}`,
  ringFocus: `focus-within:ring-2 ring-[#72ff70]/40`,
  deliverHeroIcon: `w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-[#72ff70]/30 text-[#006e16]`,
  wrapGradientBar: `h-1.5 rounded-full bg-gradient-to-r from-[#006e16] to-[#72ff70]`,
  wrapIconBg: `w-10 h-10 rounded-lg flex items-center justify-center bg-white text-[#1b1b1d] border border-black/[0.1]`,
  auditCloseBtn: `w-full h-10 gap-2 bg-[#006e16] hover:bg-[#00530e] text-white`,
  trustCenterCta: `inline-flex items-center px-8 py-4 rounded-md font-bold text-[#002203] bg-[#72ff70] transition-all border border-transparent ${SF} hover:brightness-110 hover:-translate-y-0.5 [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  chaosGradient: `text-transparent bg-clip-text bg-gradient-to-r from-[#000000] to-[#006e16]`,
  realityBadge: `inline-flex items-center px-4 py-2 rounded-md text-xs font-bold tracking-widest uppercase mb-6 text-[#002203] bg-[#72ff70] [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  rotatingBadge: `inline-flex items-center px-4 py-2 rounded-md text-xs font-bold tracking-widest uppercase text-[#002203] bg-[#72ff70] [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  rotatingBadgeIcon: `w-3.5 h-3.5 mr-2 text-[#006e16] stroke-2`,
  rotatingAccentLine: `absolute -left-6 top-16 bottom-2 w-0.5 bg-gradient-to-b from-[#72ff70] to-transparent rounded-full`,
  ...
  rotatingCta: `inline-flex items-center px-6 py-3 rounded-md bg-[#72ff70] text-[#002203] font-bold cursor-pointer hover:brightness-110 transition-all ${SF}`,
  problemTitleHover: `group-hover:text-[#006e16] transition-colors`,
  headlineMuted: `text-[#006e16]`,
  carouselTabActive: `text-[#002203] bg-[#72ff70]`,
  carouselTabInactive: `text-[#45474c] hover:text-[#1b1b1d] hover:bg-[#f6f3f4]`,
  carouselTabIndicator: `bg-[#006e16]`,
  carouselTabDotActive: `bg-[#006e16]`,
  secureVaultCard: `rounded-lg p-8 lg:p-9 bg-white/80 backdrop-blur-md border border-[#c6c6cc]/20 shadow-2xl`,
  stitchVaultDriveRow: `text-sm font-medium text-[#006e16] mb-1 [font-family:var(--font-kinetic-headline),system-ui,sans-serif]`,
  ...
  personaIconWrap: `w-12 h-12 rounded-lg flex items-center justify-center text-[#006e16] bg-[#72ff70]/30 shrink-0 group-hover:bg-[#141c2a] group-hover:text-[#72ff70] transition-colors border border-black/[0.08]`,
  personaWorkflowSep: `text-[#006e16]/70`,
  bulletsPeach: `w-1.5 h-1.5 rounded-full bg-[#006e16] shadow-[0_0_8px_rgba(0,110,22,0.35)]`,
  useCaseIcon: `w-12 h-12 rounded-lg flex items-center justify-center text-[#1b1b1d] bg-white border border-black/[0.1] group-hover:bg-[#141c2a] group-hover:text-[#72ff70] group-hover:border-[#141c2a] transition-colors duration-300 shrink-0`,
  ...
  carouselWatermark: `absolute -bottom-10 -right-0 text-[12rem] font-bold leading-none select-none -z-10 text-[#72ff70]/15`,
