  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-[color,transform,box-shadow,background-color,border-color] duration-200 ease-out focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none disabled:translate-y-0",
  {
    variants: {
      variant: {
        ...
        /** Secondary vs solid-black checkout — violet to match billing trust panel / badges */
        manageBillingCta:
          "group relative overflow-hidden border border-violet-300/80 bg-violet-50 text-violet-950 shadow-[0_1px_2px_rgba(109,40,217,0.08)] hover:-translate-y-px hover:border-violet-400/80 hover:bg-violet-100 hover:text-violet-950 hover:shadow-[0_2px_12px_-4px_rgba(109,40,217,0.14)] focus-visible:ring-2 focus-visible:ring-violet-500/35 focus-visible:ring-offset-2 active:translate-y-0 active:scale-[0.995] active:shadow-[inset_0_2px_4px_rgba(109,40,217,0.1)] before:absolute before:inset-0 before:rounded-[inherit] before:bg-violet-200/85 before:content-[\"\"] before:[clip-path:circle(0%_at_85%_50%)] before:transition-[clip-path] before:duration-300 before:ease-out hover:before:[clip-path:circle(150%_at_85%_50%)]",
        destructive:
